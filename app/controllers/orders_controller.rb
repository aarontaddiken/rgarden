class OrdersController < ApplicationController
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:ponum, :order_date, :request_ship_date, :invoice_date, :total, :note, :contact_id, :seed_year, :rep_id, order_items_attributes: [:id, :_destroy, :product_id, :order_id, :qty_order, :qty_ship, :cost, :retail])
    end
end
